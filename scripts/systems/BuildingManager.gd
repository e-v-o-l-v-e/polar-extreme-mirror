...
static var building_descriptions = [
	...
	"Cette salle est essentielle pour le bien être des scientifiques, on peut y retrouver une bibliothèque, une télévision, des handspinners, un billard, un babyfoot, un bar à salade polonaise, un bon pc pour jouer à Cyberpunk 2077. Sert de lieu de rassemblement pour les membres de l'équipe, notamment lors des briefings hebdomadaires.",
	"Équipée de vélos, tapis de course et poids. Indispensable pour lutter contre l'atrophie musculaire et la baisse de moral induites par le confinement et le froid.",
